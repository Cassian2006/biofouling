...
const sections = [
  {
    ...
    items: [
      ...
      "FPI 用于评估单船污损倾向，ECP 用于评估潜在排放惩罚，RRI 用于评估区域综合风险。",
  ...
  },
  {
    title: "RRI 计算",
    items: [
      "RRI = 0.40 × 水域情况 + 0.25 × 交通疏密 + 0.20 × 锚地压力 + 0.15 × 行为情况。",
      "交通疏密，指的是这一格网里船流是否密集；低速停留，指的是船是否经常低速或停留。",
      "RRI 主要用于找区域热点，所以更看重水域情况、船流和锚地压力。",
    ],
  },
  {
    title: "LSTM 数据构建",
  ...
  },
  {
    ...
    items: [
      ...
      "若 FPI >= 0.40 或 ECP >= 0.55，建议纳入持续监测。",
      "其余对象归为当前优先级较低。",
    ],
  },
];
